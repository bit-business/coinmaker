  ...
  export default {
    ...
    computed: {
      controlFlow: function () {
        return `https://github.com/bit-business/coinmaker/blob/v${this.token.version}/analysis/control-flow/${this.contracts.token.contractName}.png`;
      },
      inheritanceTree: function () {
        return `https://github.com/bit-business/coinmaker/blob/v${this.token.version}/analysis/inheritance-tree/${this.contracts.token.contractName}.png`;
      },
      uml: function () {
        return `https://github.com/bit-business/coinmaker/blob/v${this.token.version}/analysis/uml/${this.contracts.token.contractName}.svg`;
      },
    },
    mounted () {
      this.initDapp();
